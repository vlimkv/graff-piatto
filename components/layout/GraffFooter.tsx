...
export function GraffFooter() {
  return (
    <>
      {/* DESKTOP FOOTER */}
      <div className="hidden xl:block">
        <footer className="relative h-[352px] bg-[#303F56] text-white">
          <div className="relative mx-auto h-full w-full max-w-[1440px]">
            <div className="absolute left-[303px] top-10">
              <span className="font-display text-2xl font-bold text-[#C9A25B]">
                GRAFF PIATTO
              </span>
            </div>
            ...
            <div className="absolute left-[303px] top-[84px] flex gap-[15px]">
              ...
              <a
                href="https://t.me/your_graff_piatto"
                aria-label="Telegram Graff Piatto"
                className="flex h-8 w-8 items-center justify-center text-white hover:text-[#C9A25B] transition-colors"
              >
                <FooterIconTelegram />
              </a>
            ...
            <div className="absolute left-[303px] top-[131px] grid grid-cols-2 gap-x-[181px] text-sm leading-[17px]">
              ...
              <div className="space-y-[0.67px]">
                <a href="#" className="block hover:text-[#C9A25B]">Новости</a>
                <a href="#" className="block hover:text-[#C9A25B]">Контакты</a>
                <a href="/about" className="block hover:text-[#C9A25B]">О бренде</a>
              </div>
            </div>
      ...
      {/* MOBILE FOOTER */}
      {/* MOBILE FOOTER - PREMIUM ADAPTATION */}
      <div className="xl:hidden">
        <footer className="bg-[#303F56] text-white">
          <div className="px-5 py-10">
            
            {/* 1. Логотип и Слоган */}
            <div className="mb-8 text-center">
              <span className="font-display text-2xl font-bold tracking-wider text-[#C9A25B]">
                GRAFF PIATTO
              </span>
              <p className="mt-2 text-[11px] text-white/60">
                Дом столовых нарядов премиального качества
              </p>
            </div>

            {/* 2. Навигация (Сетка 2 колонки) - чтобы было компактно */}
            <nav className="mb-10 grid grid-cols-2 gap-x-4 gap-y-4 border-t border-white/10 pt-8 text-[13px] font-medium leading-tight">
              ...
              <div className="flex flex-col gap-4 items-start pl-2">
                ...
                <a href="/about" className="hover:text-[#C9A25B] transition-colors">О бренде</a>
              </div>

              {/* Правая колонка */}
              <div className="flex flex-col gap-4 items-start">
                 <a href="#" className="hover:text-[#C9A25B] transition-colors">Клиентам из РФ</a>
                 <a href="#" className="hover:text-[#C9A25B] transition-colors">Новости</a>
                 <a href="#" className="hover:text-[#C9A25B] transition-colors">Контакты</a>
              </div>
            </nav>

            {/* 3. Соцсети (Крупные иконки) */}
            <div className="mb-10">
